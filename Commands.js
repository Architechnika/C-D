...
//ОПИСАНИЕ ВСЕХ ВОЗМОЖНЫХ КОМАНД
 var COMMANDS = new Array();
    //ПРОСТЫЕ КОМАНДЫ ДЛЯ ДЕЙСТВИЙ
     ...
     COMMANDS.push({ code : '7', name : "stop", imgSource: "img/commands/stop.png", undeletable : false});
    ...
    //БЛОК УСЛОВИЯ, if(blockA condition blockC) {actions}
     ...
     COMMANDS.push({ code : 'E', name : "repeatif", imgSource : "img/commands/repeatif.png", ifBlock : null, actions : [], undeletable : false});//БЛОК ПОВТОРЯЮЩИЙ actions пока ifBlock.result == true
...
function getAllCommandsMenu(OneW,OneH){
  ...
  levels.forStringArray({w : OneW, h : OneH, source : ['1234895670']},//,'456789','CWRIE']},
  function (S,X,Y,W,H)
  {
